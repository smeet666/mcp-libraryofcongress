 ...
 *
 * The Library serves everyone free of charge and publishes what it will take:
 * ten requests a minute across the site. Serialising also means a burst of tool
 * calls cannot turn into a burst of connections.
 *
