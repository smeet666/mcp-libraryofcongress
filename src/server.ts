...
export const INSTRUCTIONS = [
  ...
  "Double quotes narrow a newspaper search sharply, and the Library decides what they mean: a matched page can carry the words apart or in another order rather than the phrase as written, so read the page behind source_url before saying it printed the phrase.",
